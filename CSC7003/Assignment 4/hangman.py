...
def gameWon(secretWord,correctLetters):
  # This function returns True if game is won, False otherwise
...
def main():
  print('H A N G M A N\nYou will guess names of animals!')
  ...
  while not gameIsDone:
    ...
    if guess in secretWord:
      ...
      if gameWon(secretWord,correctLetters):
